...
public class HomeActivity extends AppCompatActivity
    ...
    //Instances
    ImageButton DucollegeIcon, DucollegeText, Cutoff, Ug_Admission;
    MediaPlayer AudioForBlind, SpeakAgain;   // Are you a blind person? & yes or no (audio)
    String Speechflag="";
    int flag=0;                              //Listening should be stopped if dialog box is clicked
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ug_Admission = findViewById(R.id.ug_admission);
        ...
        Ug_Admission.setOnClickListener(this);


        // Runs only First Time after app installed
...
*/
    ...
    public void onClick(View v) {
        ...
        if(id==R.id.ug_admission){
            Intent Ug_AdmissionIN = new Intent(HomeActivity.this,Ug_Admissions.class);
            startActivity(Ug_AdmissionIN);
